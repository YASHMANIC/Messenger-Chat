                ...
                <div className="fixed inset-0 overflow-hidden">
                    <div className="absolute inset-0 overflow-hidden">
                        <div className="fixed pointer-events-none inset-y-0 right-0 flex max-w-full pl-10">
                            ...
                            >
                                <Dialog.Panel className="pointer-events-auto max-w-md w-screen">
                                    <div className="flex flex-col h-full overflow-y-scroll bg-white py-6 drop-shadow-xl">
                                        <div className="px-4 sm:px-6">
                                            <div className="flex items-start justify-end">
                                                <div className="ml-3 flex h-7 items-center">
                                                    ...
                                                    rounded-md
                                                    bg-white
                                                    text-gray-800 hover:text-gray-600 focus:outline-none
                                        ...
                                        <div className="relative flex-1 mt-6 px-4 sm:px-6">
                                            <div className="flex flex-col items-center">
                                                ...
                                                <div className="flex gap-10 my-8">
                                                    <div onClick={() => setConfirmOpen(true)} className="flex flex-col
                                                    gap-3 items-center cursor-pointer hover:opacity-75">
